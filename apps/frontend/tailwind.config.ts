...
// Tokens v2 (design_handoff_home_vitrine/tokens/tailwind.tokens.ts). As cores de papel lêem as
// variáveis de globals.css; as rampas são fixas.
...
const config: Config = {
  ...
  theme: {
    container: {
      ...
      // Media queries não aceitam var(): mesmo valor de --container-max.
      screens: { '2xl': '1320px' },
    },
    extend: {
      fontFamily: {
      ...
      // Raio 0 em tudo (só rounded-full continua redondo).
      borderRadius: {
        DEFAULT: 'var(--radius)',
        sm: 'var(--radius)',
        md: 'var(--radius)',
      ...
      fontSize: {
        ...
        '3xl': ['var(--text-3xl)', { lineHeight: '1.08' }],
        '4xl': ['var(--text-4xl)', { lineHeight: '1.02' }],
      },
